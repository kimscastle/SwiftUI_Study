...
let exampleMovie5 = Movie(id: UUID().uuidString, name: "Hannibla", thumbnailURL: URL(string: "https://picsum.photos/200/303")!, categories: ["Dystopian", "Exciting", "Suspenseful", "Sci-Fi TV"])
